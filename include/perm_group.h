...
public:
  ...
  /** Compute the direct product of two permutation groups given as generating
   *  sets.
   *
   * \param lhs generating set for the left hand side permutation group operand
   *
   * \param rhs generating set for the right hand side permutation group operand
   *
   * \return the direct permutation group product of the permutation groups
   *         generated by `lhs` and `rhs`
   */
  static PermGroup direct_product(PermSet const &lhs, PermSet const &rhs);
  ...
  /** Compute the wreath product of two permutation groups given as generating
   *  sets.
   *
   * \param lhs generating set for the left hand side permutation group operand
   *
   * \param rhs generating set for the right hand side permutation group operand
   *
   * \return the permutation group wreath product of the permutation groups
   *         generated by `lhs` and `rhs`
   */
  static PermGroup wreath_product(PermSet const &lhs, PermSet const &rhs);
